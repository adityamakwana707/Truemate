    ...
    def analyze(self, image_path: str):
        ...
        try:
            ...
            analysis_json = {
                ...
                "confidence_score": 0,
                "visual_anomalies": [],
                "ela_analysis": "Analysis failed",
                "final_explanation": f"Technical error during analysis: {str(e)}"
            }
            meta_report = {"error": "Metadata extraction failed"}
            ela_path = None

        return {
            "meta": meta_report,
            "ai_analysis": analysis_json,
            "ela_image_path": os.path.basename(ela_path) if ela_path and os.path.exists(ela_path) else None,
            "original_image_path": os.path.basename(image_path)
        }